...
- Task AK: all 30 checked, with three lifecycle corrections and two exact-source
  upgrades. Final lifecycle is 0 active, 1 phase-out, 18 spare-part, and 24
  discontinued; remaining lifecycle debt is 0.
- CP remains disconnected 0/43. Product collection remains 308, S7-300 remains
  122/197, and S7-1200 remains 186/186.
- Next gate: Communication Processor taxonomy plus adapter preparation. Product
  exposure and SIPLUS normalization were not performed. The post-S7-300
  management gate remains unchanged.
